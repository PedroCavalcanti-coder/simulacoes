...
namespace PBDFluid
{
    ...
    public class BitonicSort : IDisposable
    {
        ...
        // The internal work buffer is limited to an even power of 2.
        // Inputs smaller than 8192 are padded internally instead of forcing
        // callers to create fake particles.
        ...
        public const int MIN_ELEMENTS = 1;
        private const int MIN_SORT_ELEMENTS = BITONIC_BLOCK_SIZE * TRANSPOSE_BLOCK_SIZE;
        ...
        private int FindNumElements(int count)
        {
            ...
            NumElements = Math.Max(NumElements, MIN_SORT_ELEMENTS);
